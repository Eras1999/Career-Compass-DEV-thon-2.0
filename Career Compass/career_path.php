...
<body>
    ...
    <section class="cover-section">
        <div class="container">
            ...
            <p class="text-center">We analyze your academic background, interests, and career goals to suggest the most
                suitable university or technical college <br>courses. Our goal is to help you make informed decisions.
            </p>
        </div>
    </section>
            ...
            <div class="form-container">
                ...
                <form method="POST" id="careerForm">
                    <div class="mb-3">
                        ...
                        <?php if ($age_error) {
                            echo "<p class='error'>$age_error</p>";
                        } ?>
                    </div>
                    <div class="mb-3">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 order-md-2 order-1">
                    ...
                    <p class="text-center">The system recommends a career path based on student inputs and suggests
                        <br>relevant courses accordingly.</p>
                    <div class="match">
