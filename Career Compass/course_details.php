        ...
        <section class="info-section">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <p class="description">
                            <?php echo htmlspecialchars(truncateDescription($course['course_description'])); ?></p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="row">
                    <?php foreach ($related_courses as $related_course) { ?>
                        <div class="col-md-4">
                            <a href="course_details.php?course_id=<?php echo htmlspecialchars($related_course['course_id']); ?>"
                                style="text-decoration: none; color: inherit;">
                                <div class="course-card">
                                    <img src="images/<?php echo htmlspecialchars($related_course['icon']); ?>"
                                        alt="<?php echo htmlspecialchars($related_course['course_name']); ?>">
                                    <div class="institute-name">
                                        <?php echo htmlspecialchars($related_course['institute_name']); ?></div>
                                    <div class="course-name"><?php echo htmlspecialchars($related_course['course_name']); ?>
                                    </div>
                                </div>
                            </a>
                        </div>
                ...
                <button onclick="window.location.href='course.php?field=<?php echo urlencode($course['field']); ?>'"
                    class="view-more-btn">View More</button>
            </div>
        </section>
    <?php } else { ?>
        <section class="info-section">
