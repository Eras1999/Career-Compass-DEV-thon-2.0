...
.latest-section .post-image {
    width: 100%;
    height: 500px; /* Allow natural height */
    object-fit: cover;
...
.latest-section .read-more:hover {
    ...
    color: #333;
    margin-bottom: 20px;
    display: inline-block; /* Allow button to be on same line */
}
.recent-section .view-all {
    background: #FFD700; /* Yellow background like in Image 2 */
    color: black;
    border: none;
    border-radius: 5px;
    padding: 10px 20px;
...
<body>
    ...
    <section class="cover-section">
        <div class="container">
            ...
            <h1>Blogs</h1>
            <p>Discover insightful blogs on career guidance, industry trends, and educational opportunities to help you make informed decisions<br> about your future. Stay updated with expert advice, success stories, and valuable resources tailored to your career aspirations.</p>
        </div>
    </section>
    ...
    <section class="latest-section">
        <div class="container">
            <?php if ($latest_post) { ?>
                <div class="post-card">
                    <img src="<?php echo htmlspecialchars($latest_post['image']); ?>" class="post-image" alt="<?php echo htmlspecialchars($latest_post['title']); ?>">
                    <div class="post-content">
                        ...
                        <p class="post-excerpt"><?php echo htmlspecialchars(truncateContent($latest_post['content'], 30)); ?></p>
                        <a href="blog_details.php?blog_id=<?php echo htmlspecialchars($latest_post['id']); ?>" class="read-more">Read More</a>
                    </div>
                </div>
            <?php } else { ?>
                ...
                <?php if (!empty($recent_posts)) { ?>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="post-card row">
                            <div class="col-md-6 p-0">
                                <img src="<?php echo htmlspecialchars($recent_posts[0]['image']); ?>" class="post-image" alt="<?php echo htmlspecialchars($recent_posts[0]['title']); ?>">
                            </div>
                            <div class="col-md-6">
                                <div class="post-content">
                                   
                                    <h4 class="post-title"><?php echo htmlspecialchars($recent_posts[0]['title']); ?></h4>
                                    <p class="post-excerpt"><?php echo htmlspecialchars(truncateContent($recent_posts[0]['content'], 70)); ?></p>
                                    <a href="blog_details.php?blog_id=<?php echo htmlspecialchars($recent_posts[0]['id']); ?>" class="read-more">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php for ($i = 1; $i < min(4, count($recent_posts)); $i++) { ?>
                        <div class="col-md-4 mb-4">
                            <div class="post-card">
                                <img src="<?php echo htmlspecialchars($recent_posts[$i]['image']); ?>" class="post-image" alt="<?php echo htmlspecialchars($recent_posts[$i]['title']); ?>">
                                <div class="post-content">
                                   
                           
                                    <h4 class="post-title"><?php echo htmlspecialchars($recent_posts[$i]['title']); ?></h4>
                                    <p class="post-excerpt"><?php echo htmlspecialchars(truncateContent($recent_posts[$i]['content'], 25)); ?></p>
                                    <a href="blog_details.php?blog_id=<?php echo htmlspecialchars($recent_posts[$i]['id']); ?>" class="read-more">Read More</a>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
            ...
            <div class="row">
                <?php if (!empty($popular_posts)) { ?>
                    <?php foreach ($popular_posts as $post) { ?>
                        <div class="col-md-4 mb-4">
                            <div class="post-card">
                                <img src="<?php echo htmlspecialchars($post['image']); ?>" class="post-image" alt="<?php echo htmlspecialchars($post['title']); ?>">
                                <div class="post-content">
                                    <div class="post-meta">
                                    ...
                                    <p class="post-excerpt"><?php echo htmlspecialchars(truncateContent($post['content'], 15)); ?></p>
                                    <a href="blog_details.php?blog_id=<?php echo htmlspecialchars($post['id']); ?>" class="read-more">Read More</a>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
