        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-12 text-center">
                    ...
                    <p>Career Compass guides you to the right career path after O/Ls and A/Ls with tailored recommendations for careers, <br>degrees, and courses.  Explore your options and make informed decisions for a brighter future!</p>
                    <div>
                        <a href="register.php" class="btn btn-join">Join Course</a>
                        <a href="#how-it-works" class="btn btn-see">See How It Works</a>
                    </div>
                </div>
            </div>
        </div>
...
<section class="what-we-do" id="how-it-works">
    <div class="container">
        ...
        <p class="text-center">Career Compass guides students in discovering suitable career paths, degrees, and courses by providing <br>personalized recommendations based on their qualifications and interests.</p>
        <br>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 mb-4">
                <div class="feature-box bluebox">
                    ...
                    <p>This system lets students enter details to get course recommendations and explore career paths interactively.</p>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 mb-4">
                <div class="feature-box">
                    ...
                    <p>The platform analyzes student data and suggests suitable university degrees or technical diplomas.</p>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 mb-4">
                <div class="feature-box">
                    ...
                    <p>Students explore careers through courses, gaining job insights, salaries, and industry demand.</p>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 mb-4">
                <div class="feature-box bluebox">
                    ...
                    <p>Students explore career paths with insights into jobs, salaries, and industry demand based on their courses.</p>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 mb-4">
                <div class="feature-box">
                    ...
                    <p>The platform offers career counseling, scholarships, and application guidance for informed decisions.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="courses-section">
        <div class="container">
            ...
            <p class="text-center">The Courses section of Career Compass provides a wide range of educational programs, <br>helping students choose the right course to match their career goals and interests.</p>
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="course-card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Learn web development with HTML, CSS, JS, and more. Build websites and start a tech career.</p>
                ...
                <div class="col-md-4 mb-4">
                    <div class="course-card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Focus on software development, programming, and system design, building a strong foundation.</p>
                            <a href="#" class="btn">Learn More &nbsp; <i class="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="course-card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Learn spatial design, planning, principles, and aesthetics to create functional spaces.</p>
                            <a href="#" class="btn">Learn More &nbsp; <i class="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div id="reviewsCarousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-indicators">
                    <?php foreach ($feedback_groups as $index => $group) { ?>
                        <button type="button" data-bs-target="#reviewsCarousel" data-bs-slide-to="<?php echo $index; ?>" class="<?php echo $index === 0 ? 'active' : ''; ?>" aria-current="<?php echo $index === 0 ? 'true' : 'false'; ?>" aria-label="Slide <?php echo $index + 1; ?>"></button>
                    <?php } ?>
                </div>
                                ...
                                <?php foreach ($group as $index => $feedback) { ?>
                                    <div class="col-md-4 col-sm-6 mb-4">
                                        <div class="review-card <?php echo $index === 0 ? 'blue' : ''; ?>">
                                            ...
                                            <div class="user-info">
                                                <img src="<?php echo $feedback['image'] ? htmlspecialchars($feedback['image']) : 'images/default-user.jpg'; ?>" alt="<?php echo htmlspecialchars($feedback['full_name']); ?>">
                                                <div>
