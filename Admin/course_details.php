...
$admin_name = "ssadmin";
$result = $conn->query("SELECT course_id, course_name, institute_name, study_mode FROM Course_Details");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="content">
        ...
        <p>Manage all course information here.</p>
        <a href="add_course.php" class="btn btn-add mb-3">Add New Course</a>
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="edit_course.php?id=<?php echo $row['course_id']; ?>" class="btn btn-edit">Edit</a>
                            <a href="delete_course.php?id=<?php echo $row['course_id']; ?>" class="btn btn-delete" onclick="return confirm('Are you sure?')">Delete</a>
                        </td>
                    </tr>
                <?php } $conn->close(); ?>
            </tbody>
