        ...
        <div class="form-container">
            <form method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-control" id="education_level" name="education_level" required>
                            <option value="AL" <?php if ($course['education_level'] == 'AL') echo 'selected'; ?>>AL</option>
                            <option value="OL" <?php if ($course['education_level'] == 'OL') echo 'selected'; ?>>OL</option>
                        </select>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="stream" class="form-label">Stream</label>
                        <select class="form-control" id="stream" name="stream" required>
                            <option value="Science" <?php if ($course['stream'] == 'Science') echo 'selected'; ?>>Science</option>
                            <option value="Technology" <?php if ($course['stream'] == 'Technology') echo 'selected'; ?>>Technology</option>
                            <option value="Commerce" <?php if ($course['stream'] == 'Commerce') echo 'selected'; ?>>Commerce</option>
                            <option value="Art" <?php if ($course['stream'] == 'Art') echo 'selected'; ?>>Art</option>
                            <option value="All" <?php if ($course['stream'] == 'All') echo 'selected'; ?>>All</option>
                        </select>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-control" id="result" name="result" required>
                            <option value="Pass" <?php if ($course['result'] == 'Pass') echo 'selected'; ?>>Pass</option>
                            <option value="Fail" <?php if ($course['result'] == 'Fail') echo 'selected'; ?>>Fail</option>
                        </select>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-control" id="higher_education" name="higher_education" required>
                            <option value="University" <?php if ($course['higher_education'] == 'University') echo 'selected'; ?>>University</option>
                            <option value="Vocational" <?php if ($course['higher_education'] == 'Vocational') echo 'selected'; ?>>Vocational</option>
                        </select>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-control" id="field" name="field" required>
                            <option value="IT" <?php if ($course['field'] == 'IT') echo 'selected'; ?>>IT</option>
                            <option value="Management" <?php if ($course['field'] == 'Management') echo 'selected'; ?>>Management</option>
                            <option value="Engineering" <?php if ($course['field'] == 'Engineering') echo 'selected'; ?>>Engineering</option>
                            <option value="Language" <?php if ($course['field'] == 'Language') echo 'selected'; ?>>Language</option>
                        </select>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-control" id="qualification_level" name="qualification_level" required>
                            <option value="Degree" <?php if ($course['qualification_level'] == 'Degree') echo 'selected'; ?>>Degree</option>
                            <option value="Diploma" <?php if ($course['qualification_level'] == 'Diploma') echo 'selected'; ?>>Diploma</option>
                            <option value="HND" <?php if ($course['qualification_level'] == 'HND') echo 'selected'; ?>>HND</option>
                            <option value="Certificate" <?php if ($course['qualification_level'] == 'Certificate') echo 'selected'; ?>>Certificate</option>
                            <option value="Foundation" <?php if ($course['qualification_level'] == 'Foundation') echo 'selected'; ?>>Foundation</option>
                        </select>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-control" id="study_mode" name="study_mode" required>
                            <option value="Full time" <?php if ($course['study_mode'] == 'Full time') echo 'selected'; ?>>Full time</option>
                            <option value="Part time" <?php if ($course['study_mode'] == 'Part time') echo 'selected'; ?>>Part time</option>
                            <option value="Online" <?php if ($course['study_mode'] == 'Online') echo 'selected'; ?>>Online</option>
                        </select>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="institute_name" class="form-label">Institute Name</label>
                        <input type="text" class="form-control" id="institute_name" name="institute_name" value="<?php echo $course['institute_name']; ?>" required>
                    </div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="course_description" name="course_description" rows="3" required><?php echo $course['course_description']; ?></textarea>
                </div>
                <div class="mb-3">
                    <label for="career_opportunity" class="form-label">Career Opportunity</label>
                    <textarea class="form-control" id="career_opportunity" name="career_opportunity" rows="3" required><?php echo $course['career_opportunity']; ?></textarea>
                </div>
                <div class="mb-3">
                    <label for="what_you_learn" class="form-label">What You Learn</label>
                    <textarea class="form-control" id="what_you_learn" name="what_you_learn" rows="3" required><?php echo $course['what_you_learn']; ?></textarea>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="module_semester1" class="form-label">Module Semester 1</label>
                        <textarea class="form-control" id="module_semester1" name="module_semester1" rows="2"><?php echo $course['module_semester1']; ?></textarea>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="module_semester2" class="form-label">Module Semester 2</label>
                        <textarea class="form-control" id="module_semester2" name="module_semester2" rows="2"><?php echo $course['module_semester2']; ?></textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="module_semester3" class="form-label">Module Semester 3</label>
                        <textarea class="form-control" id="module_semester3" name="module_semester3" rows="2"><?php echo $course['module_semester3']; ?></textarea>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="module_semester4" class="form-label">Module Semester 4</label>
                        <textarea class="form-control" id="module_semester4" name="module_semester4" rows="2"><?php echo $course['module_semester4']; ?></textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="module_semester5" class="form-label">Module Semester 5</label>
                        <textarea class="form-control" id="module_semester5" name="module_semester5" rows="2"><?php echo $course['module_semester5']; ?></textarea>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="module_semester6" class="form-label">Module Semester 6</label>
                        <textarea class="form-control" id="module_semester6" name="module_semester6" rows="2"><?php echo $course['module_semester6']; ?></textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="module_semester7" class="form-label">Module Semester 7</label>
                        <textarea class="form-control" id="module_semester7" name="module_semester7" rows="2"><?php echo $course['module_semester7']; ?></textarea>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="module_semester8" class="form-label">Module Semester 8</label>
                        <textarea class="form-control" id="module_semester8" name="module_semester8" rows="2"><?php echo $course['module_semester8']; ?></textarea>
                    </div>
                </div>
